...
func TestNewEngine_UnknownTemplate(t *testing.T) {
	context := TemplateContext{}
...
func TestRenderFileHeader(t *testing.T) {
	...
	if !strings.Contains(header, "file.go") {
...
func TestRenderFileContent_Basic(t *testing.T) {
	engine, err := NewEngine("default", TemplateContext{})
	if err != nil {
		t.Fatalf("NewEngine failed: %v", err)
	}
	...
	if err != nil {
		t.Fatalf("RenderFileContent failed: %v", err)
	}
...
func TestRenderFileContent_LongLines(t *testing.T) {
	customTemplate := OutputTemplate{
		Format: "markdown",
...
func TestRenderFileContent_FoldLongFiles(t *testing.T) {
	customTemplate := OutputTemplate{
		Format: "markdown",
		Markdown: MarkdownOptions{
			FoldLongFiles: true,
...
func TestRenderMetadata(t *testing.T) {
	...
	if !strings.Contains(metadata, "/test/project") {
...
func TestRenderTableOfContents_Disabled(t *testing.T) {
	engine, err := NewEngine("default", TemplateContext{})
	if err != nil {
		t.Fatalf("NewEngine failed: %v", err)
	}
...
func TestTemplateFunctions(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			context:  struct{ Path string }{Path: "/test/file.go"},
			expected: "file.go",
		},
		{
			name:     "ext",
...
func TestGetBuiltinTemplate(t *testing.T) {
	tmpl, exists := GetBuiltinTemplate("default")
	if !exists {
	...
	_, exists = GetBuiltinTemplate("nonexistent")
	if exists {
