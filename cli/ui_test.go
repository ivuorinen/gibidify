...
func TestUIManager_SetColorOutput(t *testing.T) {
	ui := NewUIManager()
...
func TestUIManager_SetProgressOutput(t *testing.T) {
	ui := NewUIManager()
...
func TestUIManager_StartProgress(t *testing.T) {
	tests := []struct {
		name        string
		total       int
		description string
...
func TestUIManager_UpdateProgress(t *testing.T) {
	ui, _ := createTestUI()
	ui.SetProgressOutput(true)
...
func TestUIManager_FinishProgress(t *testing.T) {
	ui, _ := createTestUI()
	ui.SetProgressOutput(true)
...
func TestUIManager_Integration(t *testing.T) {
	ui, output := createTestUI()
	...
	ui.StartProgress(3, "Processing files")
	ui.UpdateProgress(1)
